...
import { Loader2, Mail, Shield, Timer, CheckCircle } from 'lucide-react';
...
export const UserEmailVerification: React.FC<UserEmailVerificationProps> = ({
    employeeId,
    employeeEmail,
    ...
    const handleSendOTP = async () => {
        ...
        try {
            const response = await fetch('/api/user/face-profile/send-otp', {
                method: 'POST',
                headers: {
    ...
    const handleVerifyOTP = async () => {
        ...
        try {
            const response = await fetch('/api/user/face-profile/verify-otp', {
                method: 'POST',
                headers: {
                    'Content-Type': 'application/json',
                },
        ...
        <Card className="w-full max-w-md mx-auto">
            <CardHeader className="text-center">
                ...
                <p className="text-sm text-muted-foreground">
                    Để bảo mật thông tin khuôn mặt, vui lòng xác thực email
                </p>
            </CardHeader>
                ...
                {step === 'request' ? (
                    ...
                    <>
                        <div className="space-y-2">
                            <label className="text-sm font-medium">Email nhận mã xác thực</label>
